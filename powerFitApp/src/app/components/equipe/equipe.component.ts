...
export class EquipeComponent {
  equipe: Personal[] = [
    ...
    },
    {
      ...
      resumo: 'Juliana Santos é especialista em Yoga e Pilates com 6 anos de experiência, oferecendo treinos personalizados para melhorar a flexibilidade, força e equilíbrio dos alunos. Seu enfoque é no bem-estar integral, conectando corpo e mente para uma prática relaxante e restauradora.'
    },
    {
      ...
      resumo: 'Camila Oliveira é personal trainer especializada em gestantes, com 7 anos de experiência ajudando futuras mamães a manterem a saúde física e emocional durante a gestação. Ela desenvolve treinos seguros e eficazes, focando na preparação do corpo para o parto, alívio de dores e melhora da disposição.'
    },
    {
      ...
      resumo: 'João Silva é um professor de dança com mais de 6 anos de experiência, especializado em diversos estilos como ballet, jazz e hip-hop. Ele oferece aulas adaptadas para diferentes níveis e idades. Seu objetivo é promover a expressão corporal, melhorar a técnica e ajudar os alunos a se conectarem com a dança.'
    },
    {
      foto: 'https://t4.ftcdn.net/jpg/10/29/28/63/360_F_1029286381_h2SfWR9dWJ7Niht7yUdl6tPGEzHanTHl.jpg',
      nome: 'Carla Mendes',
      area: 'Personal Nutricional',
      resumo: 'Carla Mendes é personal trainer com especialização em acompanhamento nutricional, focada em ajudar seus clientes a alcançar seus objetivos de saúde e fitness por meio de uma alimentação equilibrada. Com mais de 3 anos de experiência, ela desenvolve planos alimentares adaptados para diferentes necessidades.'
    }
  ]
}
